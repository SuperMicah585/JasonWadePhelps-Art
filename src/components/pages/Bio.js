...
<p className ='absolute items-center justify-center ml-32 mr-10 mt-20 bg-white text-lg object-contain rounded-md'>
<div style={containerStyle}>
      ...
      <br />
      <p style={paragraphStyle}>
        As an artist and an educator, Jason believes strongly in the <span style={highlightedStyle}>transformative effect</span> art can have upon a community.
      </p>
      <br />
      <p style={paragraphStyle}>
