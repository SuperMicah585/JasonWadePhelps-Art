...
<div className='ml-10 relative h-content mt-72 font-thin font-moret text-black mb-10 flex items-center justify-center flex-col'>
...
<div onClick = {facebookClick} className='mt-10 ml-10 hover:opacity-50 cursor-pointer'>
...
<div onClick = {LinkedInClick} className='mt-10 ml-10 hover:opacity-50 cursor-pointer'>
